...
parser.add_argument('--save_model_freq',default=4,type=int,help="frequency to save model")
...
parser.add_argument('--lr_decay',default=70,type=int,help="learning rate")
...
parser.add_argument('--model',default='UNet',help="UNet or Transformer")

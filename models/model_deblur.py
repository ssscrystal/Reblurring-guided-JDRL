...
class VGG_Deblur(nn.Module):
    def __init__(self):
        ...
        self.channel_attention = SENetChannelAttentionModule(38)
...
#            nn.ReLU(inplace=True))
    ...
    def forward(self, im_b,pred_core):
        t = torch.cat((im_b,pred_core),dim=1)
        t = self.channel_attention(t)
        x1, x2, x3, x4, x5 = self.encoder(t)
        x6_up = self.up6(x5)
